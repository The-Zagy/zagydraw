...
const ToolbarRect: React.FC<{ rect: ZagyCanvasRectElement }> = (props) => {
    ...
    return (
        <form className="flex flex-col gap-3 p-3 text-text-800">
            <InputWithIcon
                labelName={"Stroke"}
                inputProps={{
                    type: "text",
            ...
            <fieldset className="flex flex-col">
                ...
                <div className="flex gap-2 w-full">
                    <Rad name="font-family" value={FontTypeOptions.hand}>
                        <svg
                            aria-hidden="true"
                            focusable="false"
                            role="img"
                    ...
                    <Rad name="font-family" value={FontTypeOptions.code}>
                        <svg
                            aria-hidden="true"
                            focusable="false"
                            role="img"
                    ...
                    <Rad name="font-family" value={FontTypeOptions.minecraft}>
                        <svg
                            aria-hidden="true"
                            focusable="false"
                            role="img"
            ...
            <fieldset className="flex flex-col">
                ...
                <div className="flex gap-2 w-full">
                    <Rad name="fill-style" value="solid">
                        <svg
                            aria-hidden="true"
                            focusable="false"
                            role="img"
                    ...
                    <Rad value="zigzag" name="fill-style">
                        <svg
                            aria-hidden="true"
                            focusable="false"
                            role="img"
                    ...
                    <Rad value="dots" name="fill-style">
                        <svg
                            aria-hidden="true"
                            focusable="false"
                            role="img"
            ...
            <fieldset className="flex flex-col gap-2">
                ...
                <div className="flex gap-2 w-full">
                    <Rad value="left" name="text-align">
                        <svg
                            aria-hidden="true"
                            focusable="false"
                            role="img"
                    ...
                    <Rad value="center" name="text-align">
                        <svg
                            aria-hidden="true"
                            focusable="false"
                            role="img"
                    ...
                    <Rad value="right" name="text-align">
                        <svg
                            aria-hidden="true"
                            focusable="false"
                            role="img"
